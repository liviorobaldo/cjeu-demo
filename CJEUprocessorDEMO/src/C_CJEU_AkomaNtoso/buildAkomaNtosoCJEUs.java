...
/**************************************************************************************************************************************************************/
    ...
    */
    ...
    private static String[] createOntologyIndividualAnSDFRules(String partyClass, ArrayList<SDFHead> SDFHeads, ArrayList<SDFTagger> SDFTaggersForEntityLinking)throws Exception
    {
        ...
        File tempOutputFolder = new File(rootDirectoryXmlSDFRulesPath+"/"+partyClass);
        if(tempOutputFolder.exists()==false)tempOutputFolder.mkdir();
        File outputFile = new File(tempOutputFolder.getCanonicalPath()+"/"+newIndividualName+".xml");
